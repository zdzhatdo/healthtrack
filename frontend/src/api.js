...
api.interceptors.response.use(
    ...
    async (error) => {
        ...
        // The /auth/refresh request itself goes through this same interceptor.
        // Without this exclusion, a failed refresh would try to "refresh the
        // refresh," awaiting a promise that depends on its own completion —
        // a deadlock where the request never settles and callers hang forever.
